...
- ORGANIZER:
    A file that helps you organize your current directory into pre-made folders(Text, Pictures, PDFs, etc.). Simply drag and drop the python file, ensure that you have a python installed. And then run it to organize your files into folders.